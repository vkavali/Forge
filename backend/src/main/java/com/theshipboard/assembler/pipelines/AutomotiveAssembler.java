...
@Component
public class AutomotiveAssembler implements CodeAssembler {
    private final TemplateEngine te;
    private final TemplateRegistry tr;
    private final LibraryCatalog lc;
    public AutomotiveAssembler(TemplateEngine te, TemplateRegistry tr, LibraryCatalog lc) { this.te = te; this.tr = tr; this.lc = lc; }
