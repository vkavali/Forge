...
@Component
public class MotorControlAssembler implements CodeAssembler {
    private final TemplateEngine te;
    private final TemplateRegistry tr;
    private final LibraryCatalog lc;
    public MotorControlAssembler(TemplateEngine te, TemplateRegistry tr, LibraryCatalog lc) { this.te = te; this.tr = tr; this.lc = lc; }
