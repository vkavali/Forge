  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-20 left-1/4 w-72 h-72 bg-amber-600/10 rounded-full blur-3xl" />
        <div className="absolute top-40 right-1/4 w-96 h-96 bg-orange-600/5 rounded-full blur-3xl" />
        <div className="max-w-7xl mx-auto px-6 py-28 text-center relative">
          <div className="inline-flex items-center gap-2 bg-amber-600/10 border border-amber-600/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-sm text-amber-400">AI-Powered Hardware Development Platform</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
            Build Any Hardware Project<br />
            <span className="bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">In Minutes, Not Months</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {steps.map((step, i) => (
              <div key={step.num} className="relative text-center">
                ...
                <div className="w-16 h-16 rounded-2xl bg-amber-600/10 border border-amber-600/20 text-amber-400 text-xl font-bold flex items-center justify-center mx-auto mb-4">
                  <step.icon className="w-7 h-7" />
                </div>
                <div className="text-xs text-amber-400 font-mono mb-2">Step {step.num}</div>
...
void loop() {
    ...
    delay(READ_INTERVAL_MS);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f) => (
            <div key={f.title} className="flex gap-4 p-5 rounded-xl border border-gray-800 bg-gray-900/30 hover:border-gray-700 transition-colors">
              <div className="flex-shrink-0 w-10 h-10 bg-amber-600/10 rounded-lg flex items-center justify-center">
      ...
      {/* CTA */}
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="bg-gradient-to-br from-amber-600/10 to-orange-600/10 border border-amber-600/20 rounded-2xl p-12 text-center">
